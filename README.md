[![build](https://github.com/opspec-pkgs/dockercloud.swarm.stack.deploy/actions/workflows/build.yml/badge.svg)](https://github.com/opspec-pkgs/dockercloud.swarm.stack.deploy/actions/workflows/build.yml)
